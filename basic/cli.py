...
flags.DEFINE_string("log_dir", "log", "output directory")
flags.DEFINE_string("eval_dir", "eval", "output directory")
flags.DEFINE_string("answer_dir", "answer", "output directory")
flags.DEFINE_integer("max_num_sents", 200, "num sentences max") 
flags.DEFINE_integer("max_sent_size", 1000, "output directory")
flags.DEFINE_integer("max_ques_size", 1000, "output directory")
flags.DEFINE_integer("max_word_size", 1000, "wor dise")
flags.DEFINE_integer("max_para_size", 1000, "wor dise")
flags.DEFINE_integer("char_vocab_size", 65636, "wor dise")
flags.DEFINE_integer("word_emb_size", 1000, "wor dise")
flags.DEFINE_integer("word_vocab_size", 1000, "wor dise")
flags.DEFINE_integer("emb_mat", 100, "wor dise")
def main(_):
    config = flags.FLAGS
